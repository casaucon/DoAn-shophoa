...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2023 at 12:19 PM
...
(99, 'Cao Van Nhat', 'cvnhat', '123456', 1),
(101, 'Cao Văn Nhật', 'cvnhat94', '$2y$10$haimuoihaihaimuoihai2uW4u/WO1cns8rEnZm7G4JHSfciOcVF12', 1),
(102, 'Phạm Đình Long', 'pdlong', '$2y$10$haimuoihaihaimuoihai2uW4u/WO1cns8rEnZm7G4JHSfciOcVF12', 0);
-- --------------------------------------------------------
...
(13, 'Thanh khiết', 650000, 550000, 'Hoa hồng Ecuador màu xanh bơ, Thạch thảo trắng, Hoa cẩm chướng Nhật (Green Wicky), Lá phụ', 'Màu xanh lá chính là màu tự nhiên nên luôn gợi cho người ta cảm giác gần gũi, tự nhiên. Nó cho tượng trưng cho sự phát triển, hòa thuận, tươi mát màu mỡ. Màu xanh còn thể hiện sự hi vọng, chống chọi mọi khó khăn.', 'hoa_hop_1.jpg', 2, '2022-09-29', 3),
...
(16, 'Thầm mong', 270000, 150000, 'Hoa hồng kem, Hoa hồng đỏ, Hoa Salem tím', 'Nhẹ nhàng và tao nhã, \"Thầm mong\" như một điều ước cho những điều an lành, hạnh phúc và may mắn cho người nhận. ', 'hoa_hop_4.jpg', 2, '2016-06-03', 18),
...
(68, 'Dịu dàng', 680000, 540000, 'Hoa hồng, Hoa cát tường tím, Hoa cúc tím, Hoa baby, Các loại hoa lá phụ', 'Được thiết kế với tông màu hồng tím, bình hoa Dịu dàng mang lại một vẻ đẹp dịu dàng, ngọt ngào và không kém phần lãng mạn. Những hoa cát tường tím điểm xuyết trên nền hoa hồng kết hợp đồng cúc, baby. Một bình hoa thế này sẽ là món quà tuyệt vời để chúc người luôn hạnh phúc và ngập tràn tình yêu', 'hoa_binh_4.jpg', 5, '2016-06-05', 18),
(69, 'Sum họp', 700000, 530000, 'Hoa hồng đỏ, Hoa cát tường tím, Hoa sen đá, Các loai hoa phụ khác', '\"Một chiều thênh thang,về nơi con sóng tràn Nơi đây bình yên một màu xanh gió trong lành...\". Bình hoa như nhắn gửi yêu thương đến hạnh phúc gia đình, sự sum họp quây quần bên nhau.', 'hoa_binh_5.jpg', 5, '2016-05-28', 0),
...
(76, 'Ngày cuối tuần', 450000, 230000, 'Hoa hồng, Hoa tú cầu, Hoa hoàng anh', 'Sau một tuần làm việc mệt nhoài, chúng ta đều có quyền tự thưởng cho mình những ngày nghỉ để phục hồi năng lượng. Những ngày cuối tuần có thể trôi qua nhẹ nhàng và tùy ý, miễn sao chúng khiến bản thân cảm thấy thoải mái, dễ chịu. Dựa trên ý tưởng đó, “Ngày cuối tuần” ra đời với sự tập hợp của nhiều loại hoa có điểm chung là dịu nhẹ, tinh khiết. Hy vọng rằng món quà này sẽ đem đến cho khách hàng “một làn gió mát”, giảm bớt áp lực giữa cuộc sống bộn bề lo toan, tiếp sức cho những ngày dài phía trước.', 'hoa_bo_12.jpg', 2, '2022-12-22', 0);
...
(6, 60, '2022-01-07 21:33:03', 'Hoàn Thành', 1330000),
(8, 62, '2022-01-08 10:02:02', 'Hoàn Thành', 200000),
(9, 63, '2022-01-08 10:03:35', 'Hoàn Thành', 560000),
...
(40, 92, '2022-09-29 00:44:06', 'Chưa xử lý', 250000),
(43, 92, '2022-12-21 22:23:32', 'Đã xử lý', 920000),
(44, 92, '2022-12-21 22:24:42', 'Chưa xử lý', 150000),
(45, 92, '2022-12-22 00:16:05', 'Chưa xử lý', 680000),
(46, 92, '2022-12-24 19:02:58', 'Chưa xử lý', 230000),
(47, 92, '2022-12-25 12:46:49', 'Chưa xử lý', 1370000),
(48, 92, '2023-01-04 00:31:25', 'Đã xử lý', 230000),
(49, 93, '2023-01-08 08:55:59', 'Chưa xử lý', 2810000),
(50, 93, '2023-01-08 08:56:25', 'Chưa xử lý', 230000);
...
(92, 'Cao Văn Nhật', 1, 'caovnhat2001@gmail.com', 'Đức Giang', '0964240787', 'e10adc3949ba59abbe56e057f20f883e', 0),
(93, 'cao van nhat', 1, 'caovnhat20011@gmail.com', 'Ha noi', '0955555555', 'e10adc3949ba59abbe56e057f20f883e', 0);
...
(1, 'Giảm giá 50%', '1.png', 'danh-sach-hoa', '2022-11-29 21:43:40'),
(2, 'Giao hàng tận nơi', '2.jpg', 'danh-sach-hoa', '2022-11-29 21:43:42'),
(4, 'Trang trí cây thông', '434431_cay-thong-giang-sinh.jpg', '#', '2022-12-21 23:47:41');
...
--
ALTER TABLE `hoa`
  MODIFY `MaHoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT for table `hoa_don`
--
ALTER TABLE `hoa_don`
  MODIFY `ma_hoa_don` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `khach_hang`
--
ALTER TABLE `khach_hang`
  MODIFY `ma_khach_hang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
